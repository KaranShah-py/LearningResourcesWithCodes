-- Session 3 - Introduction to Keys 
...
-- AUTOINCREMENT WITH ORDER 
-- Creating LOCATION Table
CREATE OR REPLACE TABLE Blinkit_Location_ORDERED_2025
(
    LOCATION_ID INT AUTOINCREMENT START 1 INCREMENT 1 ORDER, 
    LOCATION_STATE VARCHAR(100), 
    LOCATION_CITY VARCHAR(100), 
    PRIMARY KEY (LOCATION_ID)
);
...
SELECT *
FROM Blinkit_Location_ORDERED_2025;



-- AUTOINCREMENT WITH NOORDER
'''
-- Creating LOCATION Table
CREATE OR REPLACE TABLE Blinkit_Location_NOORDERED_2025
(
    LOCATION_ID INT AUTOINCREMENT (1,1) NOORDER, 
    LOCATION_STATE VARCHAR(100), 
    LOCATION_CITY VARCHAR(100), 
    PRIMARY KEY (LOCATION_ID)
);
...
INSERT INTO 
Blinkit_Location_NOORDERED_2025
(LOCATION_STATE, LOCATION_CITY)
VALUES 
('MAH', 'MUMBAI'), 
('MAH', 'PUNE'), 
...
SELECT *
FROM Blinkit_Location_NOORDERED_2025;



CREATE OR REPLACE TABLE orders_noorder (
    order_id NUMBER AUTOINCREMENT (1,1) NOORDER,
    customer_name STRING,
    product STRING
);

INSERT INTO orders_noorder (customer_name, product) VALUES ('Dev','Keyboard');
INSERT INTO orders_noorder (customer_name, product) VALUES ('Neha','Monitor');
INSERT INTO orders_noorder (customer_name, product) VALUES ('Harsh','Mouse');
